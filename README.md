...
- **Интеграция парсера** с существующей системой задач
...
- Нажмите **"Загрузить ZIP с сессиями"**
- Выберите архив с `.session` и `.json` файлами
- Аккаунты появятся в списке

### 2. Настройка прокси
- Откройте вкладку **"Настройки"**
- Добавьте прокси вручную или загрузите из файла
- Формат: `host:port:username:password`
- Проверьте работоспособность кнопкой **"Проверить все"**

### 3. Парсинг данных
- Перейдите на вкладку **"Парсер"**
- Выберите аккаунт для парсинга
- Укажите тип парсинга и цель (ссылка на группу/канал)
- Установите лимит записей и формат экспорта
